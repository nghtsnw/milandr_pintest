...
#define PLL_MUL  1 // Множитель тактовой частоты процессора. 1 - 8 МГц внешний кварц, 2 - 16 МГц, и т.д.

#define USE_UART1 // Указываем какой модуль UART контроллера используем - первый или второй (USE_UART1 или USE_UART2).
#define UART_RATE 115200 // Скорость обмена. В клиенте на ПК стоит такая же.
